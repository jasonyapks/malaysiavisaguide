...
export const copy: AboutCopy = {
  ...
  verify: {
    heading: "对照官方名单核查代理 —— 也包括本站披露的这两家",
    body: (
      <>
        <p>
          任何网站都能自称&ldquo;持牌&rdquo;。两项计划都公布了获授权承办申请的代理机构名单，名字在不在名单上，才是唯一算数的依据。谁在向你推销，就去查谁
          —— 顺带也把 Jason 名下这两家公司查一遍。
        </p>
        <ul className="ml-5 list-disc space-y-2">
          <li>
            <strong>MM2H</strong> ——
            旅游艺术文化部（MOTAC）的持牌 MM2H 公司名单：{" "}
            <a
            ...
            <span className="mt-1 block">
              这份名单不支持用链接预填搜索词，请自行在搜索框中输入{" "}
              <strong>MY PREMIUM</strong>。要核对的是牌照号{" "}
              <span className="font-mono text-[0.95em]">MM2H862</span>{" "}
              —— 核对号码，不要光看名字，因为那份名单上有好几家无关的公司，名字开头都一样。
            </span>
          </li>
          <li>
            <strong>PVIP</strong> ——
            移民局公布的 Premium Visa Programme 授权代理名单：{" "}
            <a
            ...
            <span className="mt-1 block">
              要核对的是 <strong>MY PR PROGRAM SDN. BHD.</strong>，排在名单第一位。
            </span>
          </li>
        </ul>
        <p>
          两份名单会随着牌照的批出与吊销而更新，请直接从政府网站打开，别用代理转发给你的副本。一家公司若不在对应的名单上，就不能替你递交申请
          —— 无论它声称自己能做什么。
        </p>
      </>
    ),
