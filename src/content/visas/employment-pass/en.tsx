...
/** English employment-pass guide copy — moved here verbatim from app/visas/employment-pass/page.tsx. */
export const copy: GuideCopy = {
  ...
  answer:
    "The Employment Pass is Malaysia's route for working for a Malaysian employer. Under the policy effective 1 June 2026 there are three categories by monthly salary: Category I from RM20,000, Category II from RM10,000, and Category III from RM5,000. Your employer applies; you cannot apply yourself.",
    ...
    <>
      ...
      <Section title="What changed, and why it matters">
        ...
        <p>
          ...
          <Link href={href("/visas/pvip/")}>PVIP</Link> in particular, which carries full work
