...
/** English student-pass guide copy — moved here verbatim from app/visas/student-pass/page.tsx. */
export const copy: GuideCopy = {
  ...
  answer:
    "A Student Pass covers non-citizens studying in Malaysia, from pre-school at age three through to postgraduate study. For higher education, EMGS screens the application and your institution submits it. The pass fee is RM60. Holders may work 20 hours a week in approved settings, and Master's and PhD students may bring dependants.",
    ...
    <>
      ...
      <Section title="The work limit, precisely">
        ...
        <p>
          ...
          at the <Link href={href("/visas/employment-pass/")}>Employment Pass</Link> instead.
        </p>
      </Section>
      ...
      <Section title="What happens after you graduate">
        <p>
          ...
          <Link href={href("/visas/employment-pass/")}>Employment Pass</Link> via a Malaysian
          employer, or — where the capital is available — into one of the{" "}
          <Link href={href("/compare/")}>long-stay programmes</Link>.
        </p>
      </Section>
    </>
  ),
