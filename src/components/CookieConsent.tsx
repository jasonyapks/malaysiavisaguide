 ...
 *
 * The other half lives in `src/app/layout.tsx`, in the inline script that runs
 * BEFORE gtag.js loads. That script sets every consent signal to "denied" by
      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-5 px-5 py-5 sm:px-8 md:flex-row md:items-center md:justify-between md:gap-8">
        <div className="space-y-1">
          ...
          <p className="text-caption leading-relaxed text-ink-muted">
            Analytics cookies help us see which guides get read. They are off
            until you turn them on, and the site works exactly the same either
            way.{" "}
            <Link
              href="/privacy/"
