...
import { copy as zhHans } from "@/content/visas/student-pass/zh-hans";
import { copy as zhHant } from "@/content/visas/student-pass/zh-hant";
...
export async function generateMetadata({
  params,
}: PageProps<"/[locale]/visas/student-pass">): Promise<Metadata> {
...
export default async function Page({
  params,
}: PageProps<"/[locale]/visas/student-pass">) {
  const { locale } = await params;
