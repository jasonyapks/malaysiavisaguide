...
relatedGuides:
  - path: "/visas/mm2h/"
    title: "the MM2H guide"
  - path: "/visas/pvip/"
    title: "the PVIP guide"
  - path: "/visas/de-rantau/"
    title: "the DE Rantau guide"
faq:
  - q: "Do I pay Malaysian tax on my salary if I only work here a few weeks a year?"
  ...
  - q: "Does the capital gains tax introduced in 2024 apply to me personally?"
    a: "No. The chargeable persons under that regime are companies, limited liability partnerships, trust bodies and co-operative societies. An individual holding shares in their own name is outside it. It reaches you only through an entity you own."
  - q: "What tax do I pay when I sell my Malaysian property?"
    a: "Real Property Gains Tax, not capital gains tax. For a non-citizen who is not a permanent resident the rate is 30% on the gain for a disposal within five years of acquisition, and 10% from the sixth year onward. Unlike citizens and PRs, foreigners never reach a 0% band."
  - q: "Is my dividend income taxed?"
    a: "Since YA2025 an individual pays 2% on dividend income above RM100,000 a year. The first RM100,000 is not taxed. Dividends from EPF, LTAT, ASNB and unit trusts, from co-operatives, and foreign-sourced dividends are all outside the charge."
  - q: "Can I claim the RM8,000 relief for my parents' medical bills if they live overseas?"
    a: "No. LHDN requires that your parents are residents of Malaysia and that the treatment, dental work or care is provided in Malaysia by a registered practitioner. Bills from a hospital in your home country do not qualify regardless of the amount."
  - q: "What do I need to do about tax before I leave Malaysia for good?"
    a: "If you are leaving for more than three months, your employer files Form CP21 with LHDN at least 30 days before you go and withholds your final salary and benefits until the tax clearance letter is issued or 90 days pass. Clearance takes roughly 14 working days when the paperwork is in order, so begin the process when you decide to leave rather than during your notice period."
  - q: "Do foreigners have to contribute to EPF?"
    a: "Yes, since wages for October 2025. Non-Malaysian citizen employees under 75 holding a valid passport and pass contribute 2%, matched by 2% from the employer. Domestic servants are excluded and there was no phase-in period."
  - q: "Does my MM2H or PVIP pass make me a Malaysian tax resident?"
    a: "No. Residency is decided on a day count under Section 7 of the Income Tax Act 1967. The pass gives you the right to be here; what you do with those days decides your tax position."
sources:
...
{% callout tone="warning" title="Your pass does not decide this" %}
An MM2H, PVIP or DE Rantau pass gives you the right to spend days in Malaysia. It does not make you a tax resident and it does not shield you from becoming one. A pass holder who lives mostly abroad is a non-resident; a frequent visitor on a social pass who stops counting is a resident.
{% endcallout %}

The full four-part residency test, and what happens to money you wire in from overseas, are covered in [our guide to foreign income and the 182-day test](/insights/expat-living/is-foreign-income-taxed-in-malaysia/). The short version on remittances: for a resident individual, foreign income brought into Malaysia is exempt to 31 December 2036, provided it was taxed where it arose. For a non-resident it is exempt outright. This is the single most misreported rule in Malaysian expat tax, and if you have read that Malaysia now taxes your foreign remittances, you have read a corporate rule.

## What each status actually costs

{% table caption="Individual income tax on Malaysian-sourced income" %}
|  | Resident | Non-resident |
| --- | --- | --- |
| **Rate** | Progressive: nil to RM5,000, then 1% rising to 30% above RM2,000,000 | Flat **30%** |
| **Personal reliefs** | Yes, the full schedule | None |
| **Rebates** | Yes | None |
| **Short-stay exemption** | n/a | 60 days or less, on conditions |
...
{% callout tone="info" title="The 60-day exemption most short-stay workers miss" %}
Under Paragraph 21 of Schedule 6, a non-resident's employment income is exempt where the employment is exercised in Malaysia for **60 days or less** in a basis year. Where a stay straddles two calendar years, the two periods are added together and must still total 60 days or less.

Three things to know. It does not apply to directors of resident companies, or to public entertainers. It is not granted automatically — you claim it in your return and carry the burden of proving you qualify. And it turns on days of employment exercised here, not simply days present.
{% endcallout %}
...
{% table caption="YA2026 reliefs from a foreign resident's point of view" %}
| Relief | Cap | Usable as a foreigner? |
| --- | --- | --- |
| **Individual (automatic)** | RM9,000 | Yes, granted without a claim |
...
| **Domestic tourism** — attractions and cultural programmes | RM1,000 | Probably, but see below |
| **Medical — parents** | RM8,000 | Almost never |
...
{% callout tone="warning" title="Tax clearance: the one that strands people at the airport" %}
If you are leaving Malaysia for more than three months, your employer must file **Form CP21** with LHDN at least **30 days before you go**, and is expected to withhold your final salary and benefits until the tax clearance letter comes back or 90 days pass, whichever is sooner. Clearance itself takes around 14 working days when the paperwork is clean, and CP21 has been an online-only submission through MyTax e-SPC since 1 January 2024.

Read that as a sequence rather than a formality. Resigning, working a one-month notice period and flying out at the end of it does not leave enough room, and the money held back is your money. Start the clearance conversation with your employer the week you decide to leave, not the week you pack.
{% endcallout %}
...
{% callout tone="warning" title="Where the company rule becomes your problem" %}
Section 15C looks through foreign structures. If shares in a controlled company incorporated outside Malaysia are disposed of, and Malaysian real property makes up 75% or more of its total tangible assets, the gain is deemed derived from Malaysia and taxed here — even though the sale happened abroad between foreign entities.

You are outside this as a private individual. You are inside it the moment you hold Malaysian property through a foreign company or trust, which plenty of people do without ever thinking of themselves as a corporate taxpayer. If that describes you, the 60-day filing clock is real and the penalties for missing it are not discretionary.
{% endcallout %}
...
{% callout tone="info" title="General information, not tax advice" %}
This article states the position as at 29 August 2026 and is written for expats, investors and business owners generally, not as personalised advice. Rates, reliefs and thresholds move at every budget, and your own position turns on facts specific to you. Confirm with a licensed Malaysian tax adviser before you act.
{% endcallout %}

{% cta %}
Your tax exposure follows the days you spend here — and the pass that lets you spend them is a separate decision with its own cost. [Which Malaysia visa actually fits your income?](/insights/comparisons/mm2h-vs-pvip-vs-de-rantau/)
{% endcta %}
